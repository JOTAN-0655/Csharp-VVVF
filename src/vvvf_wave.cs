...
namespace VVVF_Generator_Porting
{
    public class vvvf_wave
    {
		...
		public static Wave_Values calculate_tokyuu_1000_1500_IGBT(bool brake, bool mascon_on, bool free_run, double initial_phase, double wave_stat)
		{
			...
			if (brake)
			{
				...
				if (51 <= wave_stat) pulse_Mode = Pulse_Mode.P_1;
			...
			else
			{
				...
				if (47.3 <= wave_stat) pulse_Mode = Pulse_Mode.P_1;
